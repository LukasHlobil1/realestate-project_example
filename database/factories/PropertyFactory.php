...
class PropertyFactory extends Factory
{
    ...
    private function generatePropertyTitle(string $type, string $city): string
    {
        ...
        return match ($type) {
            'house' => "{$adjective} Rodinný dům v {$city}",
            'apartment' => "{$adjective} Apartmán v {$city}",
            'villa' => "{$adjective} Vila v {$city}",
            'condo' => "{$adjective} Byt v {$city}",
            'townhouse' => "{$adjective} Městský dům v {$city}",
            'land' => "Pozemek v {$city}",
            'commercial' => "{$adjective} Komerční nemovitost {$city}",
            default => "{$adjective} Nemovitost {$city}",
        };
    }
