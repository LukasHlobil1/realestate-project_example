            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <nav class="flex text-sm text-gray-500 dark:text-gray-400" aria-label="Breadcrumb">
                    <a href="{{ route('properties.index') }}"
                        class="hover:text-gray-700 dark:hover:text-gray-200">Vlastnosti</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="lg:grid lg:grid-cols-3 lg:gap-8">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            @if($property->price_per_sqft)
                                <div class="text-lg text-gray-500 dark:text-gray-400">Kč
                                    {{ number_format($property->price_per_sqft, 0) }} per
                                    Metrů čtverečních</div>
                            @endif
                        </div>
                    </div>
                        ...
                        @else
                            ...
                            <div class="h-64 bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                                <div class="text-center">
                                    ...
                                    <p class="text-gray-500 dark:text-gray-300">Žádné obrázky dostupné</p>
                                </div>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Detaily nemovitosti</h2>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            ...
                            @if($property->total_area)
                                ...
                                <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    ...
                                    <div class="text-sm text-gray-600 dark:text-gray-300">Metrů čtverečních</div>
                                </div>
                            @endif
                            ...
                            @if($property->built_year)
                                ...
                                <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    ...
                                    <div class="text-sm text-gray-600 dark:text-gray-300">Rok postavení</div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                            <div>
                                <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Informace o nemovitosti</h3>
                                <ul class="space-y-1 text-gray-600 dark:text-gray-300">
                                    ...
                                    @if($property->furnished !== null)
                                        <li><span class="font-medium">Furnished:</span>
                                            {{ $property->furnished ? 'Ano' : 'Ne' }}</li>
                                    @endif
                                    @if($property->parking)
                                        <li><span class="font-medium">Parking:</span>
                                            {{ $property->parking_spaces ? $property->parking_spaces . ' Místa ' : 'Dostupné' }}
                                        </li>
                                    @endif
                                </ul>
                            </div>
                            ...
                            @if($property->features && count($property->features) > 0)
                                <div>
                                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Vychytávky a doplňky</h3>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">O této nemovitosti</h2>
                    ...
                    @if($property->latitude && $property->longitude)
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Lokace</h2>
                            ...
                            <div class="h-64 bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center">
                                <div class="text-center">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">Interaktivní mapa -- Nedostupná !!</p>
                ...
                <div class="lg:col-span-1 mt-8 lg:mt-0">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6 top-4">
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Chcete se podívat?
                        </h3>
                        ...
                        @if($property->contact_name || $property->contact_phone || $property->contact_email)
                            ...
                            <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-2">Kontaktní informace</h4>
                                @if($property->contact_name)
                                    <p class="text-sm text-gray-600 dark:text-gray-300"><span class="font-medium">Jméno:</span>
                                        {{ $property->contact_name }}</p>
                                @endif
                                @if($property->contact_phone)
                                    <p class="text-sm text-gray-600 dark:text-gray-300"><span class="font-medium">Telefon:</span>
                                        <a href="tel:{{ $property->contact_phone }}"
                                            class="text-blue-600 hover:underline dark:text-blue-400">{{ $property->contact_phone }}</a>
                                    </p>
                                @endif
                                @if($property->contact_email)
                                    <p class="text-sm text-gray-600 dark:text-gray-300"><span class="font-medium">E-mail:</span>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Rychlé akce</h3>
                        <div class="space-y-3">
                            @if($property->contact_phone)
                                <a href="tel:{{ $property->contact_phone }}"
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 text-sm">
                        <h4 class="font-semibold text-gray-900 dark:text-white mb-2">Souhrn nemovitostí</h4>
                        <ul class="space-y-1 text-gray-600 dark:text-gray-300">
