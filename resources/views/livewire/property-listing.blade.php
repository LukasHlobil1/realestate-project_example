    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="text-center">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Najděte si vysněnou domácnost</h1>
                <p class="mt-2 text-lg text-gray-600 dark:text-gray-300">Objevte nejlepší nemovitosti ve Zlíně</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                ...
                <div>
                    ...
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Hledat</label>
                ...
                <div>
                    {{-- Adjusted label text color for better contrast in light mode --}}
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Typ nemovitosti</label>
                    <select wire:model.live="type"
                        {{-- Added text color for both modes and dark border color --}}
                        class="w-full text-gray-900 dark:text-gray-200 dark:bg-gray-700 p-2 rounded-md border border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        <option value="">Typy nemovitostí</option>
                ...
                <div>
                    {{-- Adjusted label text color for better contrast in light mode --}}
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Typ inzerátu</label>
                    <select wire:model.live="listingType"
                        {{-- Added text color for both modes and dark border color --}}
                        class="w-full text-gray-900 dark:text-gray-200 dark:bg-gray-700 p-2 rounded-md border border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        <option value="">Na prodej / pronájem</option>
                ...
                <div>
                    {{-- Adjusted label text color for better contrast in light mode --}}
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Město</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    {{-- Adjusted label text color for better contrast in light mode --}}
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Min. cena (Kč)</label>
                    <input type="number" wire:model.live.debounce.500ms="minPrice" placeholder="Min. cena"
                        {{-- Added text color for both modes and dark border color --}}
                        class="w-full text-gray-900 dark:text-gray-200 dark:bg-gray-700 p-2 rounded-md border border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
                ...
                <div>
                    {{-- Adjusted label text color for better contrast in light mode --}}
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Max. cena (Kč)</label>
                    <input type="number" wire:model.live.debounce.500ms="maxPrice" placeholder="Max. cena"
                        {{-- Added text color for both modes and dark border color --}}
                        class="w-full text-gray-900 dark:text-gray-200 dark:bg-gray-700 p-2 rounded-md border border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
                ...
                <div>
                    {{-- Adjusted label text color for better contrast in light mode --}}
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Min. počet pokojů</label>
                    <select wire:model.live="minBedrooms"
                        {{-- Added text color for both modes and dark border color --}}
                        class="w-full text-gray-900 dark:text-gray-200 dark:bg-gray-700 p-2 rounded-md border border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        <option value="">Jakýkoliv</option>
                        @for($i = 1; $i <= 6; $i++)
                            <option value="{{ $i }}">{{ $i }}+ pokojů{{ $i > 1 ? '' : '' }}</option>
                        @endfor
                    </select>
                </div>
                ...
                <div class="flex items-end">
                    <label class="flex items-center">
                        ...
                        {{-- Adjusted label text color for better contrast in light mode --}}
                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Pouze doporučené</span>
                    </label>
                </div>
            </div>
                            ...
                            <div class="relative">
                                ...
                                @if($property->isFeatured())
                                    <div class="absolute top-2 left-2">
                                        <span class="bg-yellow-500 text-white px-2 py-1 text-xs font-semibold rounded">Doporučené</span>
                                    </div>
                                @endif
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    @if($property->price_per_sqft)
                                        ...
                                        <span class="text-xs text-gray-500 dark:text-gray-400">Kč {{ number_format($property->price_per_sqft, 0) }}/sqft</span>
                                    @endif
                                </div>
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Žádné nemovitosti nalezeny</h3>
                <p class="text-gray-600 dark:text-gray-400 mb-4">Zkuste změnit vaše vyhledávání.</p>
