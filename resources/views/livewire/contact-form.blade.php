<div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <span class="font-medium">Zpráva poslaná úspěšně!</span>
                </div>
            ...
            <p class="text-sm mt-1 dark:text-green-400">Ozveme se vám do 24 hodin.</p>
        </div>
    @endif
    ...
    <form wire:submit="submit" class="space-y-4">
        <div>
            ...
            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Jméno *</label>
        ...
        <div>
            <!-- Updated: Dark mode text for label -->
            <label for="message" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Zpráva
                *</label>
            ...
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Minimálně 10 znaků</p>
        </div>
        ...
        <button type="submit" wire:loading.attr="disabled"
            ...
            <span wire:loading.remove>Poslat zprávu</span>
